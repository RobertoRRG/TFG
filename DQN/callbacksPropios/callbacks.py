# -*- coding: utf-8 -*-
"""
Created on Sun Jun  6 13:34:47 2021

@author: robertorg
"""

'''Nos creamos calbacks personalizados''
   Como Tensoboard y Wandb
'''
'''
...
class WandbLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        wandb.log({
            ...
            'learning_rate' : getattr(self.model.optimizer, 'lr', None) #Comprobar
            **metrics_dict
        })
